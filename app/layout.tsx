...
export const metadata: Metadata = {
  title: "Arbiter Legal — Juridisch besturingssysteem voor Nederlandse advocaten",
  description:
  ...
  openGraph: {
    title: "Arbiter Legal — Juridisch besturingssysteem voor Nederlandse advocaten",
    description:
      "Van eerste bericht tot afgesloten dossier. Arbiter vangt elke e-mail, WhatsApp, document en oproep automatisch op.",
  ...
  twitter: {
    ...
    title: "Arbiter Legal — Juridisch besturingssysteem voor Nederlandse advocaten",
    description: "Van eerste bericht tot afgesloten dossier.",
    images: ["/og-image.png"],
  },
};
